module.exports = app => {
    ...
    router.get("/news/init", async (req, res) => {
        ...
        const higher = await Category.findOne({
            name: '新闻分类'
        })
        ...
        const newsTitles = ["王者荣耀×谭盾丨五虎定制交响乐，用传统乐器复原中国声韵", "王者英雄导航来啦!", "【五五集结领豪礼】活动开启公告", "神秘商店开启公告", "新皮肤爆料丨龙战于野，迅疾如风，赵云新装登场！", "跨系统角色转移限量测试开启公告", "新皮肤爆料丨活动免费兑换！【盾山-圆桌骑士】新装登场", "挑战绝悟活动暂时关闭入口扩容说明", "5月1日全服不停机更新公告", "5月2日跨系统角色转移测试公告", "多模式无法匹配异常问题说明公告", "短时间内充值未到账的异常说明公告", "王者英雄导航来啦!", "【五五集结领豪礼】活动开启公告", "神秘商店开启公告", "新皮肤爆料丨龙战于野，迅疾如风，赵云新装登场！", "跨系统角色转移限量测试开启公告", "新皮肤爆料丨活动免费兑换！", "【盾山-圆桌骑士】新装登场", "挑战绝悟活动暂时关闭入口扩容说明", "5月1日全服不停机更新公告", "5月2日跨系统角色转移测试公告", "多模式无法匹配异常问题说明公告", "短时间内充值未到账的异常说明公告"]
    ...
    router.get('/heroes/:id',async(req,res)=>{
        ...
        .populate('categories items1 items2 Insc partners.hero')
        .lean()
        res.send(data)
    })
